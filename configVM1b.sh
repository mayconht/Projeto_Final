...
sudo docker run -v files:/Projeto_Final/UploaderServer/files -d -p 5000:5000 uploaderserver:latest
...
sudo docker run -v files:/Projeto_Final/UploaderClient/files -d -p 5001:5001 uploaderclient:latest 